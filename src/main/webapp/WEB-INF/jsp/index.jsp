...
<table class="table table-striped">
    <thead>
    <tr>
        <td><h1><label>Title</label></h1></td>
        <td><h1><label>Completed</label></h1></td>
        <td><h1><label>Action</label></h1></td>
    </tr>
    </thead>
    <tbody>
...
<a class="btn btn-primary" href="${pageContext.request.contextPath}/todo/create">New Item</a>
